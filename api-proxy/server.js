...
fastify.register(require('@fastify/swagger'), {
  mode: 'static',  specification: { document: swaggerDocument }
})
...
const mockKline = {
  ...
  open: 495.00, high: 501.00, low: 494.50, close: 500.50, volume: 100000000
};
...
fastify.get('/ticker', async (request, reply) => {
  ...
  const allMarkets = await Promise.all([
    getMarketData(), getGlobalIndices(), getMetalsData(), getFxData(), [mockFuture],
